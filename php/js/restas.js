document.addEventListener("DOMContentLoaded", function () {
  ...
  function prepararPagina(pagina) {
    ...
    btnEnviar.addEventListener("click", () => {
      ...
      const numDivs = formActivo.parentElement.querySelectorAll("div");
      let num1 = parseInt(numDivs[0].textContent);
      let num2 = parseInt(
        formActivo.parentElement.querySelector(".numero-inferior").textContent
      );
      // Asegurar que num1 >= num2 (como en PHP)
      if (num2 > num1) {
        let temp = num1;
        num1 = num2;
        num2 = temp;
    ...
    ejercicios.forEach((ejercicio) => {
      ...
      ejercicio.addEventListener("click", function () {
        ...
        // Vincular el formulario de la resta seleccionada con el pad numérico
