document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('btnIrPagina2_desde1')?.addEventListener('click', () => {
    ocultarPaginas();
    pagina2.style.display = 'block';
  });

  document.getElementById('btnIrPagina1_desde2')?.addEventListener('click', () => {
    ocultarPaginas();
    pagina1.style.display = 'block';
  });

  document.getElementById('btnIrPagina3_desde2')?.addEventListener('click', () => {
    ocultarPaginas();
    pagina3.style.display = 'block';
  });

  document.getElementById('btnIrPagina2_desde3')?.addEventListener('click', () => {
    ocultarPaginas();
    pagina2.style.display = 'block';
  });

  function prepararPagina(pagina) {
    const ejercicios = pagina.querySelectorAll('.resta');
    ...
    ejercicios.forEach(ejercicio => {
      ejercicio.addEventListener('click', function() {
        ...
        ejercicio.style.width = '60vw';
        ejercicio.style.height = '50vh';
